...
const phoneRouter: Router = Router()
...
var phonesApproved = ['0525370946']
var tokens = {}

phoneRouter.post("/", (req: Request, res: Response) => {
    // Check secret key validation
    if (req.body.key == creatorKey) {
        // Check if phone number exists
        if (phonesApproved[req.body.phone]) {
...
// phoneRouter.post("/entry", (req: Request, res: Response) => {
